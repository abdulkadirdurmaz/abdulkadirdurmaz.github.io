...
const Skills = ({ lang }) => {
    ...
    useEffect(() => {
        ...
        let frame;
        const speed = 0.5; // hız (px per frame)

        const step = () => {
            if (!isUserScrolling && el) {
                el.scrollLeft += speed;

                // Sonsuz döngü için yarıya gelince başa sar
    ...
    // Kullanıcı scroll yaptığında autoplay’i durdur
    const handleUserScroll = () => {
        setIsUserScrolling(true);
        clearTimeout(scrollRef.current?.pauseTimeout);

        // 2 saniye sonra tekrar autoplay başlat
        scrollRef.current.pauseTimeout = setTimeout(() => {
            ...
            <div className="container mx-auto px-6 max-w-5xl">
                ...
                <div className="mb-12">
                    ...
                    <div className="bg-gray-900/60 p-6 rounded-xl shadow max-w-4xl mx-auto">
                        ...
                        <p className="text-gray-300 mt-2 text-sm">
                            English →{" "}
                            <span className="block sm:inline">Listening: B1</span>{" "}
                            <span className="block sm:inline">Reading: B1</span>{" "}
                            <span className="block sm:inline">Writing: B1</span>{" "}
                            <span className="block sm:inline">Spoken Production: A2</span>{" "}
                            <span className="block sm:inline">Spoken Interaction: A2</span>
                        </p>
                    </div>
                </div>
                ...
                <div className="mt-16">
                    ...
                    <div
                        ...
                        className="overflow-x-auto scrollbar-hide w-full relative max-w-4xl mx-auto"
                    >
