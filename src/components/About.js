...
import resume_tr from "../docs/resume_tr.pdf";
import resume_en from "../docs/resume_en.pdf";
    ...
    return (
        <section id="about" className="py-20 bg-darkBlue/60  text-white font-consolas">
            <div className="container mx-auto flex flex-col items-center gap-9 px-6 text-center">
                ...
                {/* Profil Görseli */}
                <div className="relative w-40 h-40 md:w-56 md:h-56 rounded-full p-[3px] bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500">
                    <img
                        src={profileImg}
                        alt="Profile"
                ...
                <div className="max-w-3xl text-left">
                    ...
                    <p className="text-l leading-relaxed text-gray-300 text-center">
                        {lang === "tr"
                            ? "Merhabalar! Ben Abdulkadir. Mahallenizin yazılım mühendisiyim. Karmaşık problemleri, sistematik ve analitik bir düşünce yapısıyla ele alarak sade ve etkili çözümlere kavuşturabilirim. Teknik ve teknik olmayan ekip üyeleri arasında köprü kurabilir, fikirleri net bir şekilde aktarabilirim. Esnek ve öğrenmeye son derece açık bir yaklaşımla, yeni metodolojilere ve proje ihtiyaçlarına hızla uyum sağlar, üzerime düşen sorumluluğu en iyi şekilde yerine getirmek için azimle çalışırım. Daima 'nasıl daha iyi yapabilirim' sorusunu sorarak, içinde bulunduğum ekibe ve yürütülen işe aktif bir değer katmayı hedeflerim. Benimle çalışmak isterseniz aşağıdaki bağlantıları kullanabilir veya zaten aşağıda sizin için tasarladığım iletişim alanını kullanabilirsiniz."
                            : "Hi guys! I'm Abdulkadir. I'm your friendly neighborhood software engineer. I can approach complex problems with a systematic and analytical mindset, delivering simple and effective solutions. I can bridge the gap between technical and non-technical team members and clearly convey ideas. With a flexible and highly adaptable approach, I adapt quickly to new methodologies and project needs, and I work diligently to fulfill my responsibilities to the best of my ability. I always ask, \"How can I do it better?\" and aim to actively add value to my team and the work being done. If you'd like to work with me, you can use the links below or use the contact form I've already created for you."}
                    </p>
                </div>
                ...
                <div class="bg-darkBlue/60 w-full h-auto py-8 flex items-center justify-center gap-4 flex-wrap">
                    ...
                    <a href="http://linkedin.com/in/abdulkadir-durmaz-464916202/"
                    ...
                    <a href="https://github.com/abdulkadirdurmaz"
                        className="w-10 h-10 flex items-center justify-center rounded-lg bg-white shadow-md shadow-gray-200 group transition-all duration-300"
                        target="_blank"
                        rel="noreferrer">
                        <svg
                            class="w-6 h-6 transition-all duration-300 group-hover:scale-110 text-gray-800"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            fill="currentColor">
                            <title>GitHub</title>
                            <path d="M12 0.297C5.373 0.297 0 5.67 0 12.297c0 5.292 3.438 9.787 8.205 11.387.6.111.82-.261.82-.577
                 0-.285-.011-1.04-.017-2.04-3.338.726-4.042-1.61-4.042-1.61-.546-1.387-1.333-1.757-1.333-1.757
                 -1.089-.745.083-.729.083-.729 1.205.085 1.84 1.238 1.84 1.238 1.07 1.834 2.809 1.304 3.495.997
                 .107-.775.418-1.305.762-1.605-2.665-.304-5.467-1.333-5.467-5.932 
                 0-1.31.469-2.381 1.236-3.221-.124-.303-.536-1.524.117-3.176 0 0 1.008-.322 3.3 1.23a11.52 11.52 0 0 1 6 0
                 c2.291-1.552 3.297-1.23 3.297-1.23 .655 1.652.243 2.873.12 3.176
                 ...
                 c0-6.627-5.373-12-12-12" fill="black" />
                    ...
                    <a href={lang === "tr" ? resume_tr : resume_en}
                        className="w-100 h-10 flex items-center justify-center rounded-lg bg-white shadow-md shadow-gray-200 group transition-all duration-300 text-black text-xl">
                        <p className="px-2">
                            {lang === "tr" ? "Özgeçmişimi inceleyin" : "Check out my Resume"}
                        </p>
                        <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-file-user-icon lucide-file-user">
                            <path d="M14 2v4a2 2 0 0 0 2 2h4" /><path d="M15 18a3 3 0 1 0-6 0" /><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7z" /><circle cx="12" cy="13" r="2" />
                        </svg>
                    </a>
                </div>
            </div>
