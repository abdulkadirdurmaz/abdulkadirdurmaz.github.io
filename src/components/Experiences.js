                ...
                <div className="grid md:grid-cols-2 gap-12 items-stretch">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col space-y-6">
                            ...
                            {/* ASELSAN */}
                            <div className="bg-gray-900/60 p-6 rounded-xl shadow hover:shadow-lg transition h-full flex flex-col">
                                <a
                                ...
                                <p className="mt-2 text-gray-300 text-md font-bold">05/08/2024 - 09/09/2024</p>
                            ...
                            <div className="bg-gray-900/60 p-6 rounded-xl shadow hover:shadow-lg transition h-full flex flex-col">
                                ...
                                <p className="mt-2 text-gray-300 text-md font-bold"> 24/06/2019 - 02/08/2019</p>
                                <p className="mt-2 text-gray-300">
                                    {lang === "tr"
                            ...
                            <div className="bg-gray-900/60 p-6 rounded-xl shadow hover:shadow-lg transition h-full flex flex-col">
                                ...
                                <p className="mt-2 text-gray-300 text-md font-bold">19/12/2022 - 31/03/2023</p>
                                <p className="mt-2 text-gray-300">
                                    {lang === "tr"
                                        ? "Bionluk üzerinde farklı projelerde freelancer olarak çalıştım. Hayalini kurduğunuz projenizi gerçekleştirmek için benimle iletişime geçin."
                                        : "I've worked as a freelancer on various projects through Bionluk. Contact me to realize your dream project."}
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-col justify-between space-y-6">
                            ...
                            {/* ADÜ */}
                            <div className="bg-gray-900/60 p-6 rounded-xl shadow hover:shadow-lg transition min-h-[256px] flex flex-col">
                                <div className="flex justify-between items-start">
                                    ...
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white text-md sm:text-sm px-1 sm:px-3 py-1 rounded-md shadow transition"
                                    >
                                        <FaFilePdf size={16} />
                                ...
                                <p className="text-xl mt-2 text-gray-300">Adnan Menderes University</p>
                            ...
                            {/* Ankara Üniversitesi */}
                            <div className="bg-gray-900/60 p-6 rounded-xl shadow hover:shadow-lg transition min-h-[256px] flex flex-col h-full">
                                <div className="flex justify-between items-start">
                                    <a
                                ...
                                <p className="text-xl mt-1 text-gray-300">Ankara University</p>
                                <p className="text-md text-gray-400">
                                    04/09/2018 - 15/06/2020 <br />
                                    Ankara, Turkey
                                </p>
                                <p className="mt-2 text-gray-300">
                                    {lang === "tr"
